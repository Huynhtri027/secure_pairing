...
We propose the following leakage assessment.
...
In a similar study \cite{kumar2009comparative} some of the same authors identify the resistance of pairing methods against so-called \textit{rushing user} behaviour.
