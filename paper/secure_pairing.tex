...
Suppose we use human visual capabilities as an OOB channel, the idea is that this channel is very hard to interfere with for an attacker without the human user(s) noticing.
There are many such OOB channels, some of which we shall discuss in subsequent sections in the paper.
